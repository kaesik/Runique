package com.kaesik.run.presentation.run_active.service
...
class RunActiveService: Service() {
    ...
    private val baseNotification by lazy {
        NotificationCompat
            ...
            .setSmallIcon(com.kaesik.core.presentation.designsystem.R.drawable.logo)
    ...
    companion object {
        ...
        private const val CHANNEL_ID = "run_active"
        ...
        fun createStartIntent(context: Context, activityClass: Class<*>): Intent {
            return Intent(context, RunActiveService::class.java).apply {
                action = ACTION_START
